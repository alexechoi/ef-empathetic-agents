...
export const AudioPlayerPlayButton = ({
  ...
  <Button size="icon-sm" variant="outline" nativeButton={false} render={<MediaPlayButton className={cn("bg-transparent", className)} data-slot="audio-player-play-button" {...props} />}></Button>
);
...
export const AudioPlayerSeekBackwardButton = ({
  ...
  <Button size="icon-sm" variant="outline" nativeButton={false} render={<MediaSeekBackwardButton data-slot="audio-player-seek-backward-button" seekOffset={seekOffset} {...props} />}></Button>
);
...
export const AudioPlayerSeekForwardButton = ({
  ...
  <Button size="icon-sm" variant="outline" nativeButton={false} render={<MediaSeekForwardButton data-slot="audio-player-seek-forward-button" seekOffset={seekOffset} {...props} />}></Button>
);
